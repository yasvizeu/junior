...
const WEEKS = [
  {
    ...
    pdfs: [
      { label: "Conteúdo", url: "https://drive.google.com/file/d/1i5erCSSqoEGSMe6DTg2TEiTsTDKjm61V/view?usp=drivesdk" }
    ],

    exercises: [
      "Leia o pdf para revisão",
      "Escreva 3 frases apresentando você em inglês no seu caderno",
      "Vocabulário de cozinha - explique o passo a passo para fazer miojo",
